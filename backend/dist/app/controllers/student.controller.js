...
exports.studentsFromInstitution = function (req, res) {
	return __awaiter(void 0, void 0, void 0, function () {
		var getStudentIdsGivenInstitutionId, getListOfStudentsGivenIds;
		return __generator(this, function (_a) {
			switch (_a.label) {
				case 0:
					getStudentIdsGivenInstitutionId = function () {
						return __awaiter(void 0, void 0, void 0, function () {
							var e_1;
							return __generator(this, function (_a) {
								switch (_a.label) {
									case 0:
										...
										return [
											4 /*yield*/,
											student_model_1.default.studentsIdsFromInstitution(
													...
													if (err) {
														if (err.kind === "not_found") {
															res.status(404).send({
																success: "false",
																message:
																	"Not found Student with institution_id of " +
																	req.params.institutionId +
																	".",
															});
														} else {
															res.status(500).send({
																success: "false",
																message:
																	"Error retrieving students with institution_id " +
																	req.params.institutionId,
															});
														}
													} else getListOfStudentsGivenIds(data);
												}
											),
										];
									case 1:
					...
					getListOfStudentsGivenIds = function (arr) {
						return __awaiter(void 0, void 0, void 0, function () {
							var arrOfStudentIds_2,
							...
							return __generator(this, function (_d) {
								switch (_d.label) {
									...
									case 2:
										...
										_d.label = 3;
									case 3:
										return [4 /*yield*/, arrOfStudentIds_1.next()];
									case 4:
										if (
											!((arrOfStudentIds_1_1 = _d.sent()),
											!arrOfStudentIds_1_1.done)
										)
											return [3 /*break*/, 7];
										...
										return [
											4 /*yield*/,
											student_model_1.default.findById(
												studentId,
												function (err, result) {
													if (err) {
														if (err.kind === "not_found") {
												...
												return __generator(this, function (_a) {
													switch (_a.label) {
														case 0:
															...
															return [
																4 /*yield*/,
																res.send("is: " + arrOfStudentObjects_1),
															];
														case 1:
															_a.sent();
															return [2 /*return*/];
