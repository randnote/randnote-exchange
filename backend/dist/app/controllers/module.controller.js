...
exports.getStudentsModules = function (req, res) {
    module_model_1.default.getAllModulesPerStudent(req.params.student_id, function (err, data) {
        if (err) {
            if (err.kind === "not_found") {
                ...
                res.status(500).send({
                    success: "false",
                    message: "Error retrieving modules from a student that has the Id : " +
...
exports.getTeacherModules = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var teacher_id, getOtherData, loadData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                teacher_id = req.params.teacher_id;
                getOtherData = function () { return __awaiter(void 0, void 0, void 0, function () {
                    var info, e_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, module_model_1.default.getTeacherModuleConnections(teacher_id, function (err, data) {
                                        if (err) {
                                            if (err.kind === "not_found") {
                                                res.status(404).send({
                                                    success: "false",
                ...
                loadData = function (info) { return __awaiter(void 0, void 0, void 0, function () {
                    var ids, e_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 1:
                                _a.trys.push([1, 4, , 5]);
                                return [4 /*yield*/, info.result.map(function (item) {
                                        ids.push(item.module_id);
                                    })];
                            case 2:
                                _a.sent();
                                return [4 /*yield*/, module_model_1.default.getTeacherModulesGivenTheirIds(ids, function (err, data) {
                                        if (err) {
                                            if (err.kind === "not_found") {
                                                res.status(404).send({
                                                    success: "false",
